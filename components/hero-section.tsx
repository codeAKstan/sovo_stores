        ...
        <div className="grid md:grid-cols-2 gap-8 items-center min-h-[500px]">
          ...
          <div className="relative">
                ...
                <div
                  ...
                  className={`absolute transition-all duration-700 ease-in-out transform ${
                    index === currentSlide
                      ...
                      : index === (currentSlide + 1) % heroProducts.length
                        ? "opacity-30 translate-x-20 scale-90 z-5"
                        : index === (currentSlide - 1 + heroProducts.length) % heroProducts.length
                          ? "opacity-30 -translate-x-20 scale-90 z-5"
            ...
            <Button
              ...
              size="sm"
              onClick={prevSlide}
              className="absolute left-0 top-1/2 -translate-y-1/2 text-white hover:bg-white/20 rounded-full p-2"
            >
            ...
            <Button
              ...
              size="sm"
              onClick={nextSlide}
              className="absolute right-0 top-1/2 -translate-y-1/2 text-white hover:bg-white/20 rounded-full p-2"
            >
